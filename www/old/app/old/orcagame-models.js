...
PlayView = Backbone.View.extend({
    ...
    // guess is correct or incorrect and update the guessLevel
    ...
    doGuessMatched: function() {
        ...
        var guessLevel = parseInt(this.model.get("guessLevel"));
        if (guessLevel == 0) {
    ...
    doGuessDidntMatch: function() {
        var guessLevel = this.model.get("guessLevel");
        guessLevel += 1;
        this.model.set("guessLevel", guessLevel);
