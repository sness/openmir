...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        init: function() {
            console.log("recordingAnnotatorSpectrogramPlugin init");
            var that = this;
        ...
        updateVisibleSpectrograms: function() {
            ...
            console.log("recordingAnnotatorSpectrogramPlugin updateVisibleSpectrograms");
